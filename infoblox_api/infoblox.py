...
import requests
import json
#Disable ssl warns / we know our cert is wonky :)
...
class Infoblox(object):
    ...
    def create_host_record_no_dns(self, address, fqdn):
        ...
        payload = '{"ipv4addrs": [{"configure_for_dhcp": false,"ipv4addr": "' + ipv4addr + '"}],"name": "' + fqdn + '","view": "' + self.iba_dns_view + '","configure_for_dns":false}'
        try:
